# ***CYK Algorithm | Back End*** 💻️

<p style="text-align: justify">
    <i>Web application that detects if a context-free grammar in chomsky normal form can generate a string w using the CYK algorithm</i>
</p>
...
*The Json content for Http post request must follow this format:*
